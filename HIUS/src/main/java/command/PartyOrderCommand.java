...
public class PartyOrderCommand {
	String prrvlNo;
	String prrvNo;
	String prrvDate;
	...
	String OpPrice;
	String prNo;
	public String getPrrvlNo() {
		return prrvlNo;
	}
	public void setPrrvlNo(String prrvlNo) {
		this.prrvlNo = prrvlNo;
	}
	...
	public String getPrrvDate() {
		return prrvDate;
	}
	public void setPrrvDate(String prrvDate) {
